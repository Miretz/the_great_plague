...
namespace Characters
{
    ...
    void assignAttributePoints(Hero &hero)
    {
        ...
        while (true)
        {
            ...
            const PointsMenuInput menu{
                {"Strength", "Strength reflects the raw physical power of a character.\n  Grants additional damage with melee weapons such as swords and maces.", prevAtt.strength},
                {"Dexterity", "Dexterity reflects the speed and agility of character's physical movement.\n  Grants bonus damage with weapons such as spears, bows and daggers.", prevAtt.dexterity},
                {"Constitution", "Constitution reflects the character's health, toughness, and resilience.\n  Grants additional health, armor and various resistances.\n  Also increases the proficiency with shields.", prevAtt.constitution},
    ...
    void assignSpecialtyPoints(Hero &hero)
    {
        ...
        while (true)
        {
            ...
            const PointsMenuInput menu{
                {"One-handed", "Grants new abilities for one-handed weapons such as daggers, swords and maces.", previous.oneHanded},

...
const std::unordered_map<Race, RaceDetail> g_AllRaces{
    { Race::Human,
      { "Human",
        "The most common among the races.",
        "race_human" } },
    { Race::Repsoris,
      { "Repsoris",
        "Identified by their reptilian features and hatred of cold.",
        "race_repsoris" } },
    { Race::Ursobac,
      { "Ursobac",
        "Their large intimidating physique makes them valuable protectors.",
        "race_ursobac" } },
    { Race::Rodanto,
      { "Rodanto",
    ...
    { Race::Felidae,
      { "Felidae",
        "Recognized by their cat-like eyes. Their grace and finesse is matched by none.",
        "race_felidae" } },
    { Race::Strigifor,
      { "Strigifor",
